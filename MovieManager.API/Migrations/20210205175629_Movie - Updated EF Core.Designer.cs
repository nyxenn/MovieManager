...
namespace MMApi.Migrations
{
    ...
    [Migration("20210205175629_Movie - Updated EF Core")]
    partial class MovieUpdatedEFCore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMApi.Models.DbMovie", b =>
                {
                    b.HasOne("MMApi.Models.Person", "Director")
                        .WithMany()
                        .HasForeignKey("DirectorID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MMApi.Models.Person", "Writer")
                        .WithMany()
